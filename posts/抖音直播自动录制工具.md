...
> 主要是前几天无聊的时候想看圆圆直播，但又懒得守着她直播，于是就整了一个，大致可用，但仍存在一些小问题，如录制时间的bug，但应该不会改了，也无力维护。

项目地址：[https://github.com/reveryday/AutoStreamSync](https://github.com/reveryday/AutoStreamSync)
...
普通用户不需要安装 Python，也不需要克隆源码。直接进入项目的 Release 页面下载最新压缩包：

[https://github.com/reveryday/AutoStreamSync/releases/latest](https://github.com/reveryday/AutoStreamSync/releases/latest)
